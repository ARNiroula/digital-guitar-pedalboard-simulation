...
class SpectrumTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.input_plot.setYRange(0, 100)
        ...
        self.output_plot.setYRange(0, 100)
...
class PedalboardTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        chain_label = QLabel(
            "Signal Chain: Input → Compressor → EQ → Overdrive -> Distortion → Chorus -> Flanger -> Phaser -> Tremolo → Delay → Reverb → Output"  # noqa
        )
        ...
        self.phaser = PhaserPedal(self.sample_rate)
        ...
        pedal_layout.addWidget(self.phaser, 1, 2)
        pedal_layout.addWidget(self.tremolo, 1, 3)
        pedal_layout.addWidget(self.delay, 2, 0)
        pedal_layout.addWidget(self.reverb, 2, 1)
